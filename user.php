        ...
        <v-main app>
                           ...
                           <v-container>
                               <v-row>
                                   <v-col cols="12" sm="12" md="4" lg="4">
                                       <v-dialog v-model="Sdialog" fullscreen hide-overlay
                                           ...
                                           <v-card>
                                               ...
                                               <v-container>
                                                   ...
                                                   <v-form method="post" v-model="model.modification"
                                                           action="<?= $_SERVER['PHP_SELF'] ?>">
                                                      <?php $data = $table_user->select(['nom', 'ville', 'pays', 'password', 'tel'], "where id = " . $table_user->getId()); ?>

                                                      <?php foreach ($data as $key => $value): ?>
                                                          <v-text-field label="<?= $key ?>" name="<?= $key ?>"
                                                                        value="<?= $value ?>" filled
                                                                        :rules="<?= 'rules.' . $key ?>"></v-text-field>
                                                      <?php endforeach ?>
                                                       <v-btn :disabled="!model.modification" color="success"
                                                              type="submit" name="sauvegarder">
                                                           Sauvegarder
                                   ...
                                   <v-col cols="12" sm="12" md="4" lg="4">
                                       ...
                                       <v-dialog v-model="dialog" fullscreen hide-overlay
                                                 transition="dialog-bottom-transition">
                                           <template v-slot:activator="{ on, attrs }">
                                               <v-btn large block color="green" v-bind="attrs" v-on="on"
                                                   ...
                                                   <v-container>
                                                       <v-row>
                                                           <v-col cols="12" sm="12" md="6" lg="6" xl="6">
                                                               <h1>
                                                                   <v-subheader>Votre Photo de Profil Actuele
                                                                   </v-subheader>
                                                                   <v-img src="<?= $table_user->getProfil($table_profil) ?>"
                                                                          height="50vh" contain></v-img>
                                                               </h1>
                                                           </v-col>
                                                           ...
                                                           <v-col cols="12" sm="12" md="6" lg="6" xl="6">
                                                               ...
                                                               <v-form method="post"
                                                                       ...
                                                                       v-model="model.profil">
                                                                   <v-subheader>Choisissez Votre Nouvelle photo de
                                                                       profil
                                                                   </v-subheader>
                                                                   <v-file-input accept="image/*" chips counter
                                                                                 name="image_profil"
                                                                                 v-model="model.file"
                                                                                 prepend-icon=""
                                                                                 label="Nouvelle Photo"
                                                                                 :rules="rules.file"
                                                                                 prepend-inner-icon="mdi-camera" dense
                                                                                 filled truncate-length="50"
                                                                                 class="text-truncate">
                                                                   </v-file-input>
                                   ...
                                   <v-col cols="12" sm="12" md="4" lg="4">
                                       <v-dialog v-model="DDialog">
                                           <template #activator="{on,attrs}">
                                               ...
                                               <v-btn block v-bind="attrs" v-on="on" large color="red lighten-2">
                                           ...
                                           <v-form method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                                               ...
                                               <v-card color="info">
                                                   ...
                                                   <v-btn large color="red" type="submit" name="destroy"
                                                          class="px-5 mx-5">Oui
                                                       <v-icon right>mdi-delete</v-icon>
                                                   </v-btn>
                                                   <v-btn large class="float-right px-5 mx-5" color="green"
                                                          @click.stop="DDialog = false">Non
                               ...
                               <v-list-group>
                                   <template #activator>
                                       <v-col cols="12" md="10" sm="12">
                                           <v-list-item>
                                               <v-list-item-avatar>
                                                   <v-img src="<?= $table_user->getProfil($table_profil) ?>" color="red"
                                                          contain></v-img>
                                               </v-list-item-avatar>
           ...
           <?php else: ?>
               <v-container>
                   ...
                   <br>
                   <p class="text-center">
                       <v-alert type="info" prominent dismissible transition="fade-transition"
                                class="text-subtitle-2 font-weight-bold darken-2 text-sm-subtitle-1 text-md-h6">
