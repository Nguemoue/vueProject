                ...
                <v-list>
                    <v-list-item link href="user.php">
                        ...
                        <v-list-item-content>
                            ...
                            <v-list-item-subtitle>confirgurez votre profil</v-list-item-subtitle>
                        </v-list-item-content>
                    </v-list-item>
                    ...
                    <v-row>
                        <v-col cols="12" md="6">
                            <v-card color="grey">
                                ...
                                <video id="v" nohref="nohref" link autobuffer="" height="400px" width="100%"
                                       poster="<?= $poster_path ?>"
                                                  ...
                                                  ?>
                                                   <v-list-item link
                                                      <?= $_GET['id'] == $value["id"] ? 'disabled' : '' ?>
                                                                href="<?= $_SERVER['PHP_SELF'] . '?id=' . $value['id']; ?>&img_path=<?= $img_path ?>"
                                                                color="blue" key="<?= $key ?>">
                                                       <v-list-item-avatar>
