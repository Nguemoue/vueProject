...
<!--         <v-col cols="12" md="4" height="35vh">
          <v-card link href="videoDetail.php?id=2">
            <v-img
              src="img/img2.jpg"
              contain
              height="35vh"
        ...
        >
          ...
          ></v-progress-circular>
            ...
            <v-card-title class="text-h6">
              having the well gracefull
            </v-card-title>
          </v-card>
        </v-col>

        <v-col cols="12" md="4" height="35vh">
          <v-card href="videoDetail.php?id=3">
            <v-img
              src="img/img3.jpg"
              height="35vh"
              contain
        ...
        >
          ...
          ></v-progress-circular>
            ...
            <v-card-title class="text-h6">
              chosign the best field
            </v-card-title>
          </v-card>
        </v-col>

        <v-col cols="12" md="4" sm="6" height="35vh">
          <v-card href="videoDetail.php?id=4">
            <v-img
              src="img/img4.jpg"
              height="35vh"
              contain
